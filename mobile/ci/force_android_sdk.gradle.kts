...
// app's compileSdk. file_picker's flutter_plugin_android_lifecycle requires compiling against
// SDK 36, and firebase requires min SDK 23 — so force both on every Android module (app +
// plugins). Reflection avoids needing Android Gradle Plugin imports; the state.executed guard
// avoids "afterEvaluate when project already evaluated" (Flutter force-evaluates :app early).
subprojects {
    val forceSdk: (org.gradle.api.Project) -> Unit = { proj ->
